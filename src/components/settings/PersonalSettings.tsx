...
import { User, Bell, ChevronDown, ChevronUp, Plus, Trash2 } from 'lucide-react';
...
interface PersonalSettingsProps {
  ...
  accountManagement: { userRole: string };
}
  ...
  return (
    <Card className="bg-white">
      ...
      <CardContent className="space-y-6">
        ...
        {/* Employee Information (only show if user is an employee) */}
              ...
              <CollapsibleContent className="space-y-4 mt-4">
                {employeeDetails.educationHistory.map((education: any, index: number) => (
                  <div key={index} className="p-4 border border-gray-200 rounded-lg space-y-4">
                    ...
                    {/* ... keep existing code (education form fields) */}
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
              ...
              <CollapsibleContent className="space-y-4 mt-4">
                {employeeDetails.employmentHistory.map((employment: any, index: number) => (
                  <div key={index} className="p-4 border border-gray-200 rounded-lg space-y-4">
                    ...
                    {/* ... keep existing code (employment form fields) */}
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
