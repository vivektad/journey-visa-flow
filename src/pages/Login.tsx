...
const Login = () => {
  const [showSSOEmailInput, setShowSSOEmailInput] = useState(false);
  const [ssoEmail, setSSOEmail] = useState('');

  const handleInitialSSOClick = () => {
    setShowSSOEmailInput(true);
  };

  const handleSSOSubmit = () => {
    console.log('SSO login with email:', ssoEmail);
          ...
          {!showSSOEmailInput ? (
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="ssoEmail">Enter your work email</Label>
                <Input
                  id="ssoEmail"
                  type="email"
                  value={ssoEmail}
